<div class="form">
    <p class="note">
        <?php echo Yii::t('P3MediaModule.crud','Fields with');?> <span class="required">*</span> <?php echo Yii::t('P3MediaModule.crud','are required');?>.
    </p>
...
<div class='hint'><?php if('hint.status' != $hint = Yii::t('P3MediaModule.crud', 'hint.status')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.type' != $hint = Yii::t('P3MediaModule.crud', 'hint.type')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.language' != $hint = Yii::t('P3MediaModule.crud', 'hint.language')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.treePosition' != $hint = Yii::t('P3MediaModule.crud', 'hint.treePosition')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.begin' != $hint = Yii::t('P3MediaModule.crud', 'hint.begin')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.end' != $hint = Yii::t('P3MediaModule.crud', 'hint.end')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.keywords' != $hint = Yii::t('P3MediaModule.crud', 'hint.keywords')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.customData' != $hint = Yii::t('P3MediaModule.crud', 'hint.customData')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.label' != $hint = Yii::t('P3MediaModule.crud', 'hint.label')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.owner' != $hint = Yii::t('P3MediaModule.crud', 'hint.owner')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessCreate' != $hint = Yii::t('P3MediaModule.crud', 'hint.checkAccessCreate')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessRead' != $hint = Yii::t('P3MediaModule.crud', 'hint.checkAccessRead')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessUpdate' != $hint = Yii::t('P3MediaModule.crud', 'hint.checkAccessUpdate')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessDelete' != $hint = Yii::t('P3MediaModule.crud', 'hint.checkAccessDelete')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.createdAt' != $hint = Yii::t('P3MediaModule.crud', 'hint.createdAt')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.createdBy' != $hint = Yii::t('P3MediaModule.crud', 'hint.createdBy')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.modifiedAt' != $hint = Yii::t('P3MediaModule.crud', 'hint.modifiedAt')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.modifiedBy' != $hint = Yii::t('P3MediaModule.crud', 'hint.modifiedBy')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.guid' != $hint = Yii::t('P3MediaModule.crud', 'hint.guid')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.ancestor_guid' != $hint = Yii::t('P3MediaModule.crud', 'hint.ancestor_guid')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.model' != $hint = Yii::t('P3MediaModule.crud', 'hint.model')) echo $hint; ?></div>
</div>
...
<?php $this->widget(
					...
					array(
							...
							'style' => 'dropdownlist',
							'htmlOptions' => array(
								'checkAll' => Yii::t('P3MediaModule.crud', 'Choose all'),
								),)
						); ?><br />
</div>
