...
<div class='hint'><?php if('hint.status' != $hint = Yii::t('P3MediaMeta', 'hint.status')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.type' != $hint = Yii::t('P3MediaMeta', 'hint.type')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.language' != $hint = Yii::t('P3MediaMeta', 'hint.language')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.treePosition' != $hint = Yii::t('P3MediaMeta', 'hint.treePosition')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.begin' != $hint = Yii::t('P3MediaMeta', 'hint.begin')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.end' != $hint = Yii::t('P3MediaMeta', 'hint.end')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.keywords' != $hint = Yii::t('P3MediaMeta', 'hint.keywords')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.customData' != $hint = Yii::t('P3MediaMeta', 'hint.customData')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.label' != $hint = Yii::t('P3MediaMeta', 'hint.label')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.owner' != $hint = Yii::t('P3MediaMeta', 'hint.owner')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessCreate' != $hint = Yii::t('P3MediaMeta', 'hint.checkAccessCreate')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessRead' != $hint = Yii::t('P3MediaMeta', 'hint.checkAccessRead')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessUpdate' != $hint = Yii::t('P3MediaMeta', 'hint.checkAccessUpdate')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.checkAccessDelete' != $hint = Yii::t('P3MediaMeta', 'hint.checkAccessDelete')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.createdAt' != $hint = Yii::t('P3MediaMeta', 'hint.createdAt')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.createdBy' != $hint = Yii::t('P3MediaMeta', 'hint.createdBy')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.modifiedAt' != $hint = Yii::t('P3MediaMeta', 'hint.modifiedAt')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.modifiedBy' != $hint = Yii::t('P3MediaMeta', 'hint.modifiedBy')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.guid' != $hint = Yii::t('P3MediaMeta', 'hint.guid')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.ancestor_guid' != $hint = Yii::t('P3MediaMeta', 'hint.ancestor_guid')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.model' != $hint = Yii::t('P3MediaMeta', 'hint.model')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.id0' != $hint = Yii::t('P3MediaMeta', 'hint.id0')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.treeParent' != $hint = Yii::t('P3MediaMeta', 'hint.treeParent')) echo $hint; ?></div>
</div>
