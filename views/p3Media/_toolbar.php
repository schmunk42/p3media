                        ...
                        'buttons' => array(
                            array(
                                ...
                                'items' => array(
                                    array(
                                        'icon' => 'arrow-right',
                                        'label' => Yii::t('p3MediaModule.model', 'relation.P3MediaTranslations'),
                ...
                $this->widget(
                    ...
                    array(
                        ...
                        "visible" => $showManageButton && (Yii::app()->user->checkAccess(
                                    "P3media.P3Media.*"
                                ) || Yii::app()->user->checkAccess("P3media.P3Media.View"))
                    )
                );
                ?>        </div>
        </div>
            ...
            <div class="btn-group">
                ...
                $this->widget(
                    ...
                    array(
                        ...
                        "visible" => $showCreateButton && (Yii::app()->user->checkAccess(
                                    "P3media.P3Media.*"
                                ) || Yii::app()->user->checkAccess("P3media.P3Media.Create"))
                    )
                );
                $this->widget(
                    "bootstrap.widgets.TbButton",
                    array(
                        ...
                        "visible" => $showDeleteButton && (Yii::app()->user->checkAccess(
                                    "P3media.P3Media.*"
                                ) || Yii::app()->user->checkAccess("P3media.P3Media.Delete"))
                    )
                );
                $this->widget(
                    "bootstrap.widgets.TbButton",
                    array(
                        ...
                        "visible" => $showUpdateButton && (Yii::app()->user->checkAccess(
                                    "P3media.P3Media.*"
                                ) || Yii::app()->user->checkAccess("P3media.P3Media.Update"))
                    )
                );
                $this->widget(
                    "bootstrap.widgets.TbButton",
                    array(
                        ...
                        "visible" => $showViewButton && (Yii::app()->user->checkAccess("P3media.P3Media.*") || Yii::app(
                                )->user->checkAccess("P3media.P3Media.View")),
                        "htmlOptions" => array(
                            "data-toggle" => "tooltip",
                ...
                $this->widget(
                    ...
                    array(
                        ...
                        "visible" => $showSaveButton && (Yii::app()->user->checkAccess("P3media.P3Media.*") || Yii::app(
                                )->user->checkAccess("P3media.P3Media.View"))
                    )
                );
                ?>        </div>
...
<?php if ($this->action->id == 'admin'): ?>
    ...
    <?php Yii::beginProfile('P3Media.view.toolbar.search'); ?>    <?php $this->renderPartial(
        '_search',
        array('model' => $model,)
    ); ?>
