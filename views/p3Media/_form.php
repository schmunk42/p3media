    ...
    <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                  title='<?php echo (($t = Yii::t(
                                      ...
                                      )) != 'tooltip.info_image_magick_json') ? $t : '' ?>'>
                                <?php
    ...
    <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                  title='<?php echo (($t = Yii::t(
                                      ...
                                      )) != 'tooltip.access_domain') ? $t : '' ?>'>
                                <?php
                                echo $form->dropDownList(
                                    $model,
                                    'access_domain',
                                    P3Media::optsaccessdomain(),
                                    array('empty' => 'undefined')
                                );;
    ...
    <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                  title='<?php echo (($t = Yii::t(
                                          'p3MediaModule.model',
                                          'tooltip.access_read'
                                      )) != 'tooltip.access_read') ? $t : '' ?>'>
                                <?php
                                echo $form->dropDownList(
                                    $model,
                                    'access_read',
                                    P3Media::optsaccessread(),
                                    array('empty' => 'undefined')
                                );;
    ...
    <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                  title='<?php echo (($t = Yii::t(
                                      ...
                                      )) != 'tooltip.access_update') ? $t : '' ?>'>
                                <?php
                                echo $form->dropDownList(
                                    $model,
                                    'access_update',
                                    P3Media::optsaccessupdate(),
                                    array('empty' => 'undefined')
                                );;
    ...
    <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                  title='<?php echo (($t = Yii::t(
                                      ...
                                      )) != 'tooltip.access_delete') ? $t : '' ?>'>
                                <?php
                                echo $form->dropDownList(
                                    $model,
                                    'access_delete',
                                    P3Media::optsaccessdelete(),
                                    array('empty' => 'undefined')
                                );;
    ...
    <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                  title='<?php echo (($t = Yii::t(
                                      ...
                                      )) != 'tooltip.access_append') ? $t : '' ?>'>
                                <?php
                                echo $form->dropDownList(
                                    $model,
                                    'access_append',
                                    P3Media::optsaccessappend(),
                                    array('empty' => 'undefined')
                                );;
...
<div class="form-actions" style="visibility: hidden; height: 1px">
    ...
    <?php
    echo CHtml::Button(
        Yii::t('P3MediaModule.crud', 'Cancel'),
        array(
