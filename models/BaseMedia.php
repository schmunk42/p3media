 ...
 */
abstract class BaseMedia extends GActiveRecord{
	...
	{
		return array(
			'parent' => array(self::BELONGS_TO, 'Media', 'parent_id'),
			'medias' => array(self::HAS_MANY, 'Media', 'parent_id'),
			'mediaMetas' => array(self::HAS_MANY, 'MediaMeta', 'p3_media_id'),
		);
	}
